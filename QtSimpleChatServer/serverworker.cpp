...
void ServerWorker::sendJson(const QJsonObject &json)
{
    ...
    emit logMessage(QLatin1String("Enviando a ") + userName() + QLatin1String(" - ") + QString::fromUtf8(jsonData));
        ...
        if (socketStream.commitTransaction()) {
            ...
            if (parseError.error == QJsonParseError::NoError) {
                ...
                if (jsonDoc.isObject()) // and is a JSON object
                    ...
                    emit logMessage(QLatin1String("Mensaje inválido: ") + QString::fromUtf8(jsonData)); //notify the server of invalid data
            } else {
                emit logMessage(QLatin1String("Mensaje inválido: ") + QString::fromUtf8(jsonData)); //notify the server of invalid data
            }
