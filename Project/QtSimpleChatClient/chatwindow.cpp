...
void ChatWindow::attemptConnection()
{
    ...
    const QString hostAddress = QInputDialog::getText(
        this
        , tr("Seleccione un servidor")
        , tr("Dirección del servidor")
        , QLineEdit::Normal
...
void ChatWindow::connectedToServer()
{
    ...
    const QString newUsername = QInputDialog::getText(this, tr("Seleccione un nombre de usuario"), tr("Nombre de usuario"));
    if (newUsername.isEmpty()){
        // if the user clicked cancel or typed nothing, we just disconnect from the server
        return m_chatClient->disconnectFromHost();
    }
    // obtain keyword
    const QString keyWord = QInputDialog::getText(this, tr("Escriba una cadena de generación"), tr("Cadena de generación"), QLineEdit::Password);
    // try to login with the given username
    attemptLogin(newUsername);
    m_chatClient->setKeyWord(keyWord);
}
...
void ChatWindow::disconnectedFromServer()
{
    ...
    QMessageBox::warning(this, tr("Desconectado"), tr("El host terminó la conexión"));
...
void ChatWindow::userJoined(const QString &username)
{
    ...
    m_chatModel->setData(m_chatModel->index(newRow, 0), tr("%1 se unió al Chat").arg(username));
...
void ChatWindow::userLeft(const QString &username)
{
    ...
    m_chatModel->setData(m_chatModel->index(newRow, 0), tr("%1 Abandonó el Chat").arg(username));
    // set the alignment for the text
    m_chatModel->setData(m_chatModel->index(newRow, 0), Qt::AlignCenter, Qt::TextAlignmentRole);
    // set the color for the text
...
void ChatWindow::error(QAbstractSocket::SocketError socketError)
{
    ...
    case QAbstractSocket::ConnectionRefusedError:
        QMessageBox::critical(this, tr("Error"), tr("El host rechazó la conexión"));
        break;
    case QAbstractSocket::ProxyConnectionRefusedError:
        QMessageBox::critical(this, tr("Error"), tr("El proxy rechazó la conexión"));
        break;
    case QAbstractSocket::ProxyNotFoundError:
        QMessageBox::critical(this, tr("Error"), tr("No se pudo encontrar el proxy"));
        break;
    case QAbstractSocket::HostNotFoundError:
        QMessageBox::critical(this, tr("Error"), tr("No se pudo encontrar el servidor"));
        break;
    case QAbstractSocket::SocketAccessError:
        QMessageBox::critical(this, tr("Error"), tr("No tiene permisos para ejecutar esta operación"));
        break;
    case QAbstractSocket::SocketResourceError:
        QMessageBox::critical(this, tr("Error"), tr("Demasiadas conexiones abiertas"));
        break;
    case QAbstractSocket::SocketTimeoutError:
        QMessageBox::warning(this, tr("Error"), tr("La operación tardó demasiado"));
        return;
    case QAbstractSocket::ProxyConnectionTimeoutError:
        QMessageBox::critical(this, tr("Error"), tr("El proxy tardó demasiado"));
        break;
    case QAbstractSocket::NetworkError:
        QMessageBox::critical(this, tr("Error"), tr("Incapaz de alcanzar la red"));
        break;
    case QAbstractSocket::UnknownSocketError:
        QMessageBox::critical(this, tr("Error"), tr("Un error desconocido ocurrió"));
        break;
    case QAbstractSocket::UnsupportedSocketOperationError:
        QMessageBox::critical(this, tr("Error"), tr("Operación no soportada"));
        break;
    case QAbstractSocket::ProxyAuthenticationRequiredError:
        QMessageBox::critical(this, tr("Error"), tr("Tu proxy requiere autenticación"));
        break;
    case QAbstractSocket::ProxyProtocolError:
        QMessageBox::critical(this, tr("Error"), tr("La comunicación con el proxy falló"));
        break;
    case QAbstractSocket::TemporaryError:
    case QAbstractSocket::OperationError:
        QMessageBox::warning(this, tr("Error"), tr("La operación falló, por favor ejecútela otra vez"));
        return;
    default:
        Q_UNREACHABLE();
    }
